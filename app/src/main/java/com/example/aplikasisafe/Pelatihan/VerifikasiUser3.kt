...
class VerifikasiUser3 : AppCompatActivity(), View.OnClickListener {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_verifikasi_user3)
    ...
    override fun onClick(v: View) {
        when(v.id){
            R.id.button_ya -> {
                val intent = Intent(this@VerifikasiUser3, VerifikasiUser4::class.java)
